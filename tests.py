...
class TestBooksCollector:
    ...
    ### METHOD add_new_book
    def test_add_new_book_add_two_books(self, collector, book_1_name, book_2_name):
        collector.add_new_book(book_1_name)
        collector.add_new_book(book_2_name)
        assert collector.get_books_rating() == {book_2_name: 1,
                                                book_1_name: 1 }
    ...
    def test_add_new_book_add_two_equal_books_added_one(self, collector_with_1_book, book_1_name):
        ...
        assert collector_with_1_book.get_books_rating() == {book_1_name: 1}
    ...
    def test_get_books_with_specific_rating_positive_rating(self, collector_with_books, books_ratings, rating):
        ...
        # бред, зато не используется len()
        assert collector_with_books.get_books_with_specific_rating(rating) == books_ratings[rating]
    @pytest.mark.parametrize('rating', negative_rating)
    ...
    def test_add_book_in_favorites_add_existing_book_added(self, collector_with_1_book, book_1_name):
        ...
        assert collector_with_1_book.get_list_of_favorites_books() == [book_1_name]
    def test_add_book_in_favorites_add_not_existing_book_not_added(self, collector_with_1_book, book_2_name):
        ...
        assert collector_with_1_book.get_list_of_favorites_books() == []
